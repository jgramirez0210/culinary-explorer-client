...
// function RestaurantForm({ editObj = null, onDishCreated = () => {} }) {
...
//         <Form.Control type="text" name="restaurant_name" value={formInput.restaurant_name} onChange={handleChange} placeholder="Enter restaurant name" />
//       </Form.Group>
//       <Form.Group controlId="description">
//         <Form.Label>Restaurant Address</Form.Label>
//         <Form.Control type="text" name="description" value={formInput.restaurant_address} onChange={handleChange} placeholder="Restaurant Address" />
//       </Form.Group>
//       <Form.Group controlId="notes">
//         <Form.Label>Website Url</Form.Label>
//         <Form.Control type="text" name="notes" value={formInput.website_url} onChange={handleChange} placeholder="Website URL" />
//       </Form.Group>
